...
<div class="container py-4">
    ...
    <div class="row align-items-md-stretch">
        ...
        <form name="newBook" action="./processAddBook.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                <label class="col-sm-2"><fmt:message key="rekeaseDate"/></label>
                <div class="col-sm-3">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-5">
                    <textarea name="description" id = "description" cols="50" row="2" class="form-control" placeholder="100자 이상 적어주세요"></textarea>
                </div>
            </div>
            <div class="mb-3 row">
